#!/bin/bash
# See: https://cms-pdmv.cern.ch/mcm/requests?prepid=HIG-RunIIFall17wmLHEGS-00054&page=0&shown=270339
# Sets up the CMSSW release needed for producing LHE+GEN level events with a central ttH gridpack
...
curl -s --insecure https://cms-pdmv.cern.ch/mcm/public/restapi/requests/get_fragment/HIG-RunIIFall17wmLHEGS-00054 --retry 2 --create-dirs -o Configuration/GenProduction/python/HIG-RunIIFall17wmLHEGS-00054-fragment.py 
[ -s Configuration/GenProduction/python/HIG-RunIIFall17wmLHEGS-00054-fragment.py ] || exit $?;

scram b
cd ../../
nevts=42
fragment=HIG-RunIIFall17wmLHEGS-00054-fragment.py
seed=$(date +%s)
