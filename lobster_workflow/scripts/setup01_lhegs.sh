...
scram b
cd ../../
cmsDriver.py Configuration/GenProduction/python/HIG-RunIIFall17wmLHEGS-00040-fragment.py --fileout file:HIG-RunIIFall17wmLHEGS-00040ND.root --mc --eventcontent RAWSIM,LHE --datatier GEN-SIM,LHE --conditions 93X_mc2017_realistic_v3 --beamspot Realistic25ns13TeVEarly2017Collision --step LHE,GEN,SIM --nThreads 8 --geometry DB:Extended --era Run2_2017 --python_filename HIG-RunIIFall17wmLHEGS-00040_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 1412 || exit $? ; 
