...
# with command line options: step1 --mc --eventcontent NANOEDMAODSIM --datatier NANOAODSIM --conditions 106X_mc2017_realistic_v8 --step NANO --nThreads 8 --era Run2_2017,run2_nanoAOD_106Xv1 --filein file:MAOD-00000.root --fileout file:NAOD-00000.root --python_filename UL17_NAOD_cfg.py --no_exec
