...
# with command line options: step1 --mc --eventcontent NANOEDMAODSIM --datatier NANOAODSIM --conditions 106X_upgrade2018_realistic_v15_L1v1 --step NANO --nThreads 8 --era Run2_2018,run2_nanoAOD_106Xv1 --filein file:MAOD-00000.root --fileout file:NAOD-00000.root --python_filename UL18_NAOD_cfg.py --no_exec
