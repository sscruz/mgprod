...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIIFall17wmLHEGS-00040-fragment.py nevts:30'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIIFall17wmLHE-00000ND.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    ...
    #args = cms.vstring('/afs/crc.nd.edu/user/a/awightma/work/mcm2lobster/RunIIFall17/ttHJetTobb/madgraph5aMC_NLO/ttH_ctG_slc6_amd64_gcc630_CMSSW_9_3_0_tarball.tar.xz'),
    args = cms.vstring('/hadoop/store/user/awightma/gridpack_scans/2018_04_17/ttH_ctG_run1_slc6_amd64_gcc630_CMSSW_9_3_0_tarball.tar.xz'),
